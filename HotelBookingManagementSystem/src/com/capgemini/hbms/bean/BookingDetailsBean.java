...
public class BookingDetailsBean {
	...
	public BookingDetailsBean(String bookingId, String roomId, String userId, LocalDate bookedFrom,
			LocalDate bookedTo, int noOfAdults, int noOfChildren, double amount) {
		super();
